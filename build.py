...
<nav class="navlinks" aria-label="Main calculator categories">""" + menu_links + """</nav>
</div></header>"""
...
@media(max-width:1180px){.nav{align-items:flex-start}.navlinks{flex:1;overflow-x:auto;flex-wrap:nowrap;justify-content:flex-start;padding-bottom:4px;scrollbar-width:thin}.category-nav-link{flex:0 0 auto}}
