...
def calculator_page(site, calc, related):
    ...
    calculator_asset_version = "20260925c" if calc.get("slug") in PRIORITY_LENGTH_CONVERSIONS else "20260925d" if calc.get("slug") in ("car-depreciation-calculator", "car-resale-value-calculator") else calculator_asset_versions.get(calc.get("slug"), ASSET_VERSION)
    if calc.get("engine") == "loan_page":
